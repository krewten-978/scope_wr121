...
\item Some ambitious men are not tyrants.
\item No honorable murder is just.
\item All prophecies are dangerous claims.
\end{enumerate}
...
\item Caesar alone is dangerous to the republic.
\item Macbeth is not free if the prophecy is certain.
\end{enumerate}
...
\item “Caesar is ambitious.” (Does this mean all of Caesar's actions are ambitious, or some? What exactly is being asserted?)
\item “Macbeth is fated.” (What subject and predicate would make this claim precise enough to test?)
\end{enumerate}
...
At the bottom, write a short portfolio paragraph explaining why making the quantity and quality explicit changes how the claim could be supported or challenged. If you use \textit{Macbeth} or \textit{Julius Caesar}, explain how the clearer proposition changes the literary argument.
