...
- Lit Example worksheet: `lit-examples/U1L7LE_lit_example_worksheet.tex` / `.pdf` (**U1L7LE**)
...
latexmk -pdf -interaction=nonstopmode -halt-on-error lit-examples/U1L7LE_lit_example_worksheet.tex
```
