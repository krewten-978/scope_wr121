...
At the bottom the professor adds: ``State each claim in precise proposition form. Where a word seems to carry more than one meaning, fix the term before you proceed. I cannot mark the record or decide what follows until this work is done.''

The Head Tutor, passing by, adds one further reminder on a small card tacked beneath:

\focusbox{``Do not ask first whether the claim sounds right. Ask first whether the words stay faithful to one meaning and whether the exact quantity and quality have been made clear. Only then can you test what, if anything, follows.''}

\clearpage

\section*{Part I: Fix Terms and Translate Three Statements}

Three of the professor's statements contain a word that may be carrying two different meanings. For each, identify the two-faced word, state both senses, fix the term to one consistent meaning, and then translate the repaired claim into standard form. Label subject, predicate, quality, and quantity.
...
\section*{Part II: Translate Two Additional Statements}

Choose two more statements from the professor's full list of ten. Translate each into standard form and label the elements. (You may select any except the three already treated in Part I.)

\textbf{Statement number chosen:} \rule{0.8in}{0.4pt} \hfill \textbf{Statement number chosen:} \rule{0.8in}{0.4pt}

\vspace{0.3em}
\textbf{First chosen claim (restate briefly):} \studentline

\propblock

\vspace{0.3em}
\textbf{Second chosen claim (restate briefly):} \studentline

\propblock

\Needspace{0.38\textheight}
\section*{Part III: Spiral from Week 1}
...
\Needspace{0.38\textheight}
\section*{Part IV: Spiral from Week 2}
...
\Needspace{0.42\textheight}
\section*{Part V: What Can Logic Decide?}
...
\Needspace{0.38\textheight}
\section*{Part VI: Repair or Clarify One Claim}
