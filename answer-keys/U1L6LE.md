# U1L6LE – Lit Example Worksheet Answer Key & Rubric
...
- **Valid:** if the premises were true, the conclusion would have to follow.
- **Invalid:** the conclusion would not have to follow even if the premises were true.
- **Sound:** valid and all premises true.
- **Unsound:** invalid, or valid with at least one false premise.
- **Not yet proved:** a premise has not been adequately supported; the argument should not be accepted as sound yet even if it may later be shown sound.
- **Fact test:** checking whether premises are true, false, doubtful, or unproved.

Grade for keeping the form test and fact test separate.
