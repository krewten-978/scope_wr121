...
For each argument, name the parts and test the reasoning. Some arguments are weak. At least one is stronger than it first appears.
...
Write one original argument about a school rule, a character in a story, a public speech, a sports decision, or a family disagreement. Then analyze your own argument.
...
\focusbox{Logic helps a reader most when \rule{2.2in}{0.4pt} because \rule{2.4in}{0.4pt}.}
