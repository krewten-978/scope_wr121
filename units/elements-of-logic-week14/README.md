...
- `lit-examples/U1L14LE_lit_example_worksheet.tex`
- `lit-examples/U1L14LE_lit_example_worksheet.pdf`
...
latexmk -pdf -output-directory=lit-examples -interaction=nonstopmode -halt-on-error lit-examples/U1L14LE_lit_example_worksheet.tex
```
