...
\section*{Passage 1: Excerpts from Act 1, Scenes 1 and 3 --- Fair and Foul}

\textbf{Context:} The witches open the play by joining opposites. Later, Macbeth echoes their language before he even hears their prophecy. The repeated language introduces a pattern that continues throughout the play: what appears attractive, favorable, or successful may not be morally good.
...
Shakespeare joins outward appearance, favorable circumstances, and moral judgment in the words \textit{fair} and \textit{foul}. Throughout the play, watch whether characters move too quickly from ``this appears fair'' or ``this favors me'' to ``this is good or right.'' Poetry can hold these meanings together; sound reasoning must distinguish them.

\textbf{Reading task:} As you continue through the play, watch for things that appear attractive, favorable, or successful but may be morally corrupt---and for things that appear unpleasant or threatening but may reveal the truth.
...
Both speakers use the word \textit{man}, but they press it in different directions. Macbeth's sentence sets a limit; Lady Macbeth's reply challenges that limit. From this point on, the reader notes will not supply the two senses for you. Use the passage to decide what each speaker means and whether Lady Macbeth's pressure works logically.

\textbf{Reading task:} Underline Macbeth's sentence about what befits a man. Circle Lady Macbeth's pressure words: \textit{afeard}, \textit{coward}, \textit{dare}, and \textit{man}. Do not write the worksheet answer yet; mark the evidence you will need.
...
Macbeth repeats \textit{done} because the word is carrying pressure. Do not assume every repetition has the same force. Ask what kind of completion Macbeth is imagining in each phrase, and what kind of completion he cannot actually control. Your worksheet answer should name the senses yourself.

\textbf{Reading task:} Box the repeated word \textit{done}. In the margin, write two possible senses before deciding which ones matter for the worksheet.
