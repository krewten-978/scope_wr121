...
- In an O proposition (“Some S are not P”), the subject term S is not distributed, because the claim concerns only some members of S. The predicate term P is distributed, because the proposition excludes those particular S from the whole class P.
