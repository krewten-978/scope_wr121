...
Banquo and Macbeth respond differently to the same facts. Banquo warns that a true statement can still be dangerous if it leads a person toward a false inference. Macbeth notices that part of the prophecy has come true, but he also notices that his own imagination is moving toward murder. The passage invites a logical distinction between \textit{a prediction being partly confirmed} and \textit{a murder becoming justified, necessary, or excused}.
...
This passage is unusually useful for logic because Macbeth almost lays out an argument against murder. He considers consequences, reciprocal violence, justice, loyalty, hospitality, Duncan's virtues, and his own motive. The passage also separates \textit{motive} from \textit{proof}. Macbeth may want the crown, and ambition may push him toward action, but wanting something does not prove that it is right, necessary, or unavoidable.

\textbf{Reading task:} Track the reasons Macbeth gives against the murder. Then notice the final turn: what does he say is actually pushing him forward?
