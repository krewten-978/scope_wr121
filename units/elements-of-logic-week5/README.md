...
- Logic lab: `logic-labs/U1L5LL_logic_lab.tex` / `.pdf` (**U1L5LL**)
- Answer key: `answer-keys/U1L5LL.md`
- Lit Example reader: `lit-examples/U1L5LE_lit_example_reader.tex` / `.pdf` (**U1L5LE**)
- Lit Example worksheet: `lit-examples/U1L5LE_lit_example_worksheet.tex` / `.pdf` (**U1L5LE**)
...
latexmk -pdf -interaction=nonstopmode -halt-on-error logic-labs/U1L5LL_logic_lab.tex
latexmk -pdf -interaction=nonstopmode -halt-on-error lit-examples/U1L5LE_lit_example_reader.tex
latexmk -pdf -interaction=nonstopmode -halt-on-error lit-examples/U1L5LE_lit_example_worksheet.tex
```
