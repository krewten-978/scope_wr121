...
- `../../../graded-assignments/U1L3LL/worksheet.tex`
- `../../../graded-assignments/U1L3LL/worksheet.pdf` — Assignment ID **U1L3LL**
...
```bash
latexmk -pdf -interaction=nonstopmode -halt-on-error logic-labs/../../../graded-assignments/U1L3LL/worksheet.tex
```
