...
\GraderSetup{assignment-id=U1L8LE,template-revision=2}
...
From Macbeth's point of view in Passage 1, which greeting is already established, which is not yet established, and which explicitly concerns the future? Why does that difference matter for a stable argument?
