...
- Lit Example worksheet: `lit-examples/U1L8LE_lit_example_worksheet.tex` / `.pdf` (**U1L8LE**)
...
latexmk -pdf -interaction=nonstopmode -halt-on-error lit-examples/U1L8LE_lit_example_worksheet.tex
```
