...
\section*{Two lines to keep in view}
...
You may use other details from the play, but you do not need outside research.
...
\item use at least two brief quotations or exact details from \textit{Macbeth};
