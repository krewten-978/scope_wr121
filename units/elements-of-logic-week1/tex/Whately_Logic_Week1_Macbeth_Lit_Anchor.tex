...
\section*{Guided Text: Act 1, Scene 3}
Read the original text below. The side notes are light glosses only; they do not replace the text. Watch for the movement from \textit{prediction} to \textit{interpretation}.
...
\textbf{Reason:} The witches predicted it, and one part of their greeting has already come true.\\
\textbf{Hidden assumption:} If one part of the prophecy comes true, the rest may be reliable.\\
\textbf{Test:} The claim is plausible, but not certain. One fulfilled prediction gives Macbeth reason to wonder; it does not prove that every further implication is trustworthy.

\item \textbf{Dangerous claim:} Macbeth should act to become king.\\
\textbf{Reason:} He has been told he will become king.\\
\textbf{Hidden assumption:} If something is predicted, Macbeth is justified in helping it happen.\\
\textbf{Test:} The conclusion does not follow. Prediction is not permission. Possibility is not command. Desire is not proof.

\item \textbf{Moral claim Macbeth has not proved:} Murder may be a legitimate path to the promised future.\\
\textbf{Reason:} Macbeth imagines kingship and murder together.\\
\textbf{Hidden assumption:} A promised future can excuse the means used to reach it.\\
\textbf{Test:} The conclusion does not follow. Macbeth's imagination has moved faster than his proof.
\end{enumerate}

\focusbox{\textbf{Lesson 1 takeaway:} Logic can show that Macbeth's conclusion has outrun his evidence. But logic alone cannot make Macbeth virtuous. Whately's point is confirmed: logic can discipline judgment, but it cannot replace moral character.}

\section*{Discussion}
Use these questions to prepare for the independent passage.

\begin{enumerate}[leftmargin=*]
\item What exactly do the witches tell Macbeth? What do they not tell him?
\item What does Macbeth add to the prophecy from his own imagination?
\item Why is Banquo's question, ``What, can the devil speak true?'' logically important?
\item What does Macbeth mean when he says, ``If chance will have me king, why, chance may crown me, / Without my stir''?
\item Even if Macbeth has reason to believe he may become king, does that give him reason to murder Duncan?
\item Where does logic help us understand Macbeth, and where do we need moral judgment beyond logic?
\end{enumerate}

\section*{Independent Text: Act 1, Scene 7}
...
\begin{enumerate}[leftmargin=*]
\item What conclusion does Macbeth's soliloquy seem to support?\studentline\studentline
\item List three reasons Macbeth gives against murdering Duncan.\studentline\studentline\studentline
\item What is Macbeth's only ``spur'' toward the murder? Is that spur a reason, a desire, or both?\studentline\studentline
\item State one hidden assumption behind Macbeth's hesitation.\studentline\studentline
\item Test the reasoning: if Macbeth's conclusion is ``I should not murder Duncan,'' does that conclusion follow from his reasons? Explain.\studentline\studentline\studentline
\item What does this passage show about Whately's claim that logic can discipline reasoning but cannot replace virtue?\studentline\studentline\studentline
\end{enumerate}

\section*{Portfolio Artifact: Macbeth Argument Skeleton}
...
\textbf{Claim / conclusion:}\studentline
\textbf{Stated reason:}\studentline
\textbf{Hidden assumption:}\studentline
\textbf{Does the conclusion follow? Why or why not?}\studentline\studentline\studentline
