...
\begin{itemize}[leftmargin=*]
\item Students complete the portfolio window note task from the Lab, preferably using one proposition from \textit{Macbeth} or \textit{Julius Caesar}.
