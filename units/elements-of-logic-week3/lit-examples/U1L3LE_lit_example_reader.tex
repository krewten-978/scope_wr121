...
\setlist[itemize]{topsep=0.2em,parsep=0pt,partopsep=0pt}
\pagestyle{fancy}
\fancyhf{}
...
\textbf{Reading task:} Mark each line as command, warning, claim, or conditional prediction. Put a star beside the line that seems easiest to translate into standard form.
...
Macbeth's confidence depends on how a class has been named. The phrase \textit{of woman born} is doing logical work, and Macduff's answer puts pressure on that phrase. From here, you need to decide how the class should be translated and whether Macbeth has been relying on a clearer claim than the language actually gave him.

\textbf{Reading task:} Underline the phrase \textit{of woman born}. Circle Macduff's answer. In the margin, write what classification problem the answer creates without solving it for yourself yet.
