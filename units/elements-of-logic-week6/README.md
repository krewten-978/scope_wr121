...
- `pdfs/Whately_Logic_Week6_Argument_Lab.pdf`
...
latexmk -pdf -lualatex -interaction=nonstopmode -halt-on-error -outdir=pdfs tex/Whately_Logic_Week6_Argument_Lab.tex
