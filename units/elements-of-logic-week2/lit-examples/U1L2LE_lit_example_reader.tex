...
The words \textit{fair} and \textit{foul} can name more than one kind of judgment. Here is your most assisted example: \textit{fair} may point toward beauty, favor, honor, or apparent good; \textit{foul} may point toward ugliness, filth, corruption, or something unfavorable. In poetry, Shakespeare can press these meanings together. In logic, however, you must ask whether a claim about one sense proves a claim about another sense.
